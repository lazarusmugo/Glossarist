package io.github.lazarusmugo.glossarist.processor
...
class StringResourceProcessor(
    ...
    override fun process(resolver: Resolver): List<KSAnnotated> {
        ...
        val annotatedFiles =
            resolver.getSymbolsWithAnnotation("io.github.lazarusmugo.glossarist.localization.annotations.GenerateStrings")
                ...
                file.declarations
                    ...
                    .forEach { prop ->
                        ...
                        if (resolvedType.declaration.qualifiedName?.asString() ==
                            "io.github.lazarusmugo.glossarist.localization.extension.StringsProperty"
                        ) {
    ...
    private fun generateStringsFile(resources: List<ClassName>) {
        val fileSpec =
            FileSpec
                .builder("io.github.lazarusmugo.glossarist.generated", "GeneratedStrings")
                .addType(
                    TypeSpec
